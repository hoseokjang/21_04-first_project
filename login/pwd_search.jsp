...
<div id="third">
 ...
 <form method="post" action="pwd_search_ok.jsp">
  ...
  <div style="text-align:center">
   <h3> <span class="tt">비밀번호 찾기</span> </h3>
   <p class="advice">
   <span class="st">"비밀번호가 생각나지 않으세요?"
   <br>
   "회원정보를 입력 하신 후 확인 버튼을 클릭해주세요."
    ...
    <tr>
     <td> <input type="text" class="text_form" name="userid" placeholder="아이디"><p></td>
    </tr>
    <tr>
     <td> <input type="text" name="name" class="text_form" placeholder="이 름"><p></td>
    </tr>
    <tr>
 ...
 <div style="text-align:center" >
   <h3> <span class="tt">비밀번호 찾기 완료 </span> </h3>
   <p class="advice">
   <span class="st">"비밀번호찾기 본인인증에 성공하셨습니다."
   <br>
   "입력하는 정보와 일치하는 비밀번호 목록입니다. "
    </span>
    </p>
  </div>
 <p align="center" style="font-size:20px">당신의 비밀번호는 ${imsi}입니다.</p>
 <div align="center">
