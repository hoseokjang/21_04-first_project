...
.pay_method li{
   ...
   text-align:center; position:relative; margin-left:2px; border-radius:12px;
}
...
function openPopup_pay(){
	if(document.getElementById("credit").checked){
		window.open("pay_credit.jsp", "신용카드 결제", "width=400, height=500, left=100");
	}
}
function click_pay1(){
 ...
 <table width="800" align="center" id="table_btm">
  ...
  <tr>
   <td align="center">
     ...
     <input type="hidden" name="order_price" id="order_price" value="${Integer.parseInt(pdto.prod_price)*n}">
   	 </div>
   </td>
  </tr>
 </table>
